...
public:
		...
		gui::IGUIEnvironment* env, video::IVideoDriver* driver)
	{
		...
		gui::IGUIFont* font = env->getFont("/home/virako/irrlicht-1.8/media/fonthaettenschweiler.bmp");
		if (font)
			skin->setFont(font);
...
private:
	...
	void setMaterial()
	{
		...
		case 1: type = video::EMT_NORMAL_MAP_TRANSPARENT_VERTEX_ALPHA;
			break;
		case 3: type = video::EMT_PARALLAX_MAP_TRANSPARENT_VERTEX_ALPHA;
			break;
        case 2: type = video::EMT_SOLID;
			break;
        case 4: type = video::EMT_SOLID_2_LAYER;
			break;
        case 5: type = video::EMT_LIGHTMAP;
			break;
        case 6: type = video::EMT_NORMAL_MAP_SOLID;
			break;
        case 7: type = video::EMT_PARALLAX_MAP_SOLID;
			break;
        case 8: type = video::EMT_ONETEXTURE_BLEND;
			break;
        case 9: type = video::EMT_FORCE_32BIT;
			break;
...
int main()
{
	...
	*/
	...
	// add irrlicht logo
	env->addImage(driver->getTexture("/home/virako/irrlicht-1.8/media/irrlichtlogo3.png"),
	...
	*/
	...
	scene::IAnimatedMesh* roomMesh = smgr->getMesh("/home/virako/irrlicht-1.8/media/room.3ds");
	...
	if (roomMesh)
	{
		...
		*/
		...
		video::ITexture* normalMap =
			driver->getTexture("/home/virako/irrlicht-1.8/media/rockwall_height.bmp");
...
*/
		...
		*/
		...
		room->setMaterialTexture(0,
				driver->getTexture("/home/virako/irrlicht-1.8/media/rockwall.jpg"));
	...
	*/
	...
	scene::IAnimatedMesh* earthMesh = smgr->getMesh("/home/virako/ofw/media/obrero_andando.md2");
	if (earthMesh)
	{
		...
		core::matrix4 m;
		m.setScale ( core::vector3df(5,5,5) );
		...
		video::ITexture* earthNormalMap = driver->getTexture("/home/virako/ofw/media/picacode_tex.jpg");
		if (earthNormalMap)
		{
	...
	*/
	...
	bill->setMaterialTexture(0, driver->getTexture("/home/virako/irrlicht-1.8/media/particlegreen.jpg"));
	...
	*/
	...
	bill->setMaterialFlag(video::EMF_ZWRITE_ENABLE, false);
	bill->setMaterialType(video::EMT_TRANSPARENT_ADD_COLOR);
	bill->setMaterialTexture(0, driver->getTexture("/home/virako/irrlicht-1.8/media/particlered.bmp"));
	...
	ps->setMaterialTexture(0, driver->getTexture("/home/virako/ofw/media/picacode_tex.jpg"));
